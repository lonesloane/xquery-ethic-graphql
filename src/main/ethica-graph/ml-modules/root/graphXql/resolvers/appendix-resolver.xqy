...
declare function gxqlr:appendix-entity-resolver($var-map as map:map) as element(*, gxql:Appendix)?
{
    let $uri :=
        ...
        then
            ...
            cts:uris('', (), cts:and-query((
              cts:element-value-query(xs:QName('eth:type'), 'Appendix'),
