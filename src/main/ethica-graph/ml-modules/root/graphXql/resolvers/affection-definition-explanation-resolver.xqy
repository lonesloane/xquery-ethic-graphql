    ...
    let $uri :=
        ...
        then
            cts:uris('', (), cts:and-query((
              ...
              cts:element-value-query(xs:QName('eth:affection-definition-number'), map:get($var-map, 'affectionDefinitionNumber')),
...
declare function gxqlr:affection-definition-explanation-field-resolver($field-name as xs:string) as xdmp:function
{
    ...
    else if ($field-name eq 'affectionDefinitionNumber') then xdmp:function(xs:QName('gxqlr:affection-definition-number-resolver'))
    else
