...
declare function gxqlr:proposition-lemme-definition-field-resolver($field-name as xs:string) as xdmp:function
{
    ...
    else if ($field-name eq 'propositionLemmeNumber') then xdmp:function(xs:QName('gxqlr:pldf-proposition-lemme-number-resolver'))
    else if ($field-name eq 'propositionNumber') then xdmp:function(xs:QName('gxqlr:pldf-proposition-number-resolver'))
    else
